...
ggplot(data = CreditSubs, aes(x = NumberOfDependents, y = NumberOfOpenCreditLinesAndLoans, color = Delinquency)) + geom_count() + theme_light() + facet_wrap(~Delinquency) + xlim(-.5, 10.1) + labs(x = "Number of Dependents", y = "Number of Open Credit Lines and Loans") + labs(title = "Delinquency with Number of Credit Lines/Loans and Dependents")
