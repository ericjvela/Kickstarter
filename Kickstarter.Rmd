...
```{r}
ggplot(data = newKickTrain, aes(goal, pledged)) + geom_jitter(aes(colour = state))
...
KickStar$main_categoryPublishing <- ifelse(KickStar$main_category == "Publishing",1,0)
...
KickStar$categoryReadytowear <- ifelse(KickStar$category == "Ready-to-wear",1,0)
