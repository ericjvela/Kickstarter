...
KickStar$main_categoryFilm&Video <- ifelse(KickStar$main_category == "Film & Video",1,0)
...
KickStar$categoryReady-to-wear <- ifelse(KickStar$category == "Ready-to-wear",1,0)
